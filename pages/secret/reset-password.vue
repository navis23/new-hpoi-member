    ...
    <div class="relative overflow-hidden">
        ...
        <div class="relative min-h-screen bg-gray-800 px-4 lg:px-32 overflow-hidden">
            <div class="flex flex-col gap-6 w-full min-h-screen items-center justify-center">
                <h3 class="font-oswald text-gsi-smokewhite text-4xl text-center mb-4"><span class="text-hpoi-main underline underline-offset-4">Reset Password Akun</span> Anggota anda</h3>
                <div class="relative overflow-hidden z-40 bg-gsi-smokewhite w-96  shadow-xl rounded-xl px-4 lg:px-8 py-6">
                    ...
                    <div v-if="errorExist" class="flex w-full gap-x-1 items-center justify-start my-2">
                        ...
                        <p class="text-hpoi-red text-sm">
                            Email tidak sesuai / tidak terdaftar, coba gunakan email anda yang terdaftar.
                        </p>
                    </div>
                    ...
                    <div class="border-t-2 pt-4">
                        <ButtonBase v-if="loading == false" @click="sendReset()" class="flex items-center justify-center gap-x-1 ">
...
const sendReset = async () => {
    ...
    if(anggota != null){
        ...
        if(error){
            ...
            if(data){
                ...
                setTimeout(async () => {
                    ...
                    email.value = ''
                    password.value = ''
                    navigateTo('/secret/confirm-reset')
                }, 1000);
            } else {
                console.log(error)
                setTimeout(async () => {
        ...
        console.log('email data not exist, change to other email')
        console.log(err)
