    ...
    <div class="relative overflow-hidden">
        ...
        <div class="relative min-h-screen bg-gray-800 px-4 lg:px-32 overflow-hidden">
            <div class="flex flex-col gap-3 w-full min-h-screen items-center justify-center">
                <h3 class="font-oswald text-gsi-smokewhite text-3xl text-center">Terima kasih sudah melakukan pendaftaran akun anggota HPOI.</h3>
                <h3 class="font-oswald text-gsi-smokewhite text-3xl text-center mb-4">silahkan <span class="underline text-hpoi-main">cek email anda</span> untuk konfirmasi akun baru anda.</h3>
